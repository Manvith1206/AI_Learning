...
class ConfigManager:
    ...
    def __init__(self, config=None):
        self.config = config or {
            ...
            constants.CONFIG_LLM: {constants.CONFIG_TYPE_PARAM: LLMServiceType.GEMINI.value, constants.CONFIG_PARAM: {constants.CONFIG_MODEL: GeminiLLMModel.GEMINI_FLASH.value}},
