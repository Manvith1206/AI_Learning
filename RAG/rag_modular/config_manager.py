...
class ConfigManager:
    ...
    def __init__(self, config=None):
        self.config = config or {
            ...
            constants.CONFIG_EMBEDDER: {constants.CONFIG_TYPE_PARAM: EmbedderType.TFIDF.value},
            ...
            constants.CONFIG_RERANKER: {constants.CONFIG_TYPE_PARAM: RerankerType.COSINE.value, constants.CONFIG_PARAM: {}},
