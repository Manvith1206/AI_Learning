...
class ConfigManager:
    ...
    def __init__(self, config=None):
        self.config = config or {
            ...
            constants.CONFIG_EMBEDDER: {constants.CONFIG_TYPE_PARAM: EmbedderType.TFIDF.value, constants.CONFIG_MODEL: constants.CohereEmbedModels.COHERE_EMBED_MODEL_DEFAULT.value},
            ...
            constants.CONFIG_RERANKER: {constants.CONFIG_TYPE_PARAM: RerankerType.LLM.value, constants.CONFIG_PARAM: {constants.CONFIG_METRIC_COSINE: constants.CONFIG_METRIC_COSINE}},
            constants.CONFIG_LLM: {constants.CONFIG_TYPE_PARAM: LLMServiceType.GEMINI.value, constants.CONFIG_MODEL: GeminiLLMModel.GEMINI_FLASH.value},
