...
class UIDisplayNameConstants:
    ...
    LOADING_DISPLAY_MESSAGE_FOR_MAIN_PAGE = "Initializing Main Page"
    ...
    FAIL_TO_INITIALIZE_CUSTOM_EVALUATOR = ""

class ConfigManagerNames:
...
class Constants:
    ...
    ENCODING_NAME_FOR_TOKEN_COUNT = "cl100k_base"

    EXTRACTED_TEXT_FILE_PATH = "ExtractedTextFromPdf.txt"
    ...
    SEARCH_INPUT_TYPE_FOR_COHERE_EMBED = "search_document" 

    BGE_SMALL_EMBED_MODEL = "local:BAAI/bge-small-en-v1.5"
    PIPELINE = "pipeline"
...
class ThresholdTypeForSemanticChunkinLangChain:
    PERCENTILE = "percentile"
    STANDARD_DEVIATION = "standard_deviation"
    INTERQUARTILE = "interquartile"
    GRADIENT = "gradient"

class JinaRerankerConstants:
    API_ENDPOINT_URL = "https://api.jina.ai/v1/rerank"
...
class PineConeStorageConstants:
    PINE_CONE_INDEX_NAME = "test-rag-v1"

class ChromaStorageConstants:
...
class DeepEvalMetricsConstants:
