...
class ConfigManager:
    ...
    def __init__(self, config=None):
        self.config = config or {
            ...
            constants.CONFIG_LLM: {constants.CONFIG_TYPE_PARAM: LLMServiceType.CLAUDE.value, constants.CONFIG_PARAM: {constants.CONFIG_MODEL: constants.CLAUDE_MODELS.CLAUDE_SONNET_THREE_7.display_name}},
